...
// ! PROBLEM: the file order;
// * IDEA: set up an ORDER.txt file, read from it, make it an order of files -- then use it (or better -- use to order the directory?)
// ? not liking it though (all this thing with the directory reading would become quite an overkill then...)
...
// * Previous contents of the 'examples.mjs' follow commented out;
// TODO: pray do rewrite [and update] it in the '/test' directory used by this script...
